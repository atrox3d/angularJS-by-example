	...
	function($scope, $interval, $location){
		...
		function startWorkout () {
			...
			restExercise = {
				...
				duration: $scope.workoutPlan.restBetweenExercises
			};
		...
		//
		// startExercise function literal
		//
		...
		//
		// createWorkout function literal
		//
